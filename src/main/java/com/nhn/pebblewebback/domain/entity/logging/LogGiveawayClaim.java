package com.nhn.pebblewebback.domain.entity.logging;
...
@Table(indexes = @Index(name = "idx_logGiveawayClaim_suiAddress", columnList = "suiAddress"))
public class LogGiveawayClaim {
  ...
  public final boolean equals(final Object obj) {
    ...
    final LogGiveawayClaim that = (LogGiveawayClaim) obj;
