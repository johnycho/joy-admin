package com.nhn.pebblewebback.application.filter;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.nhn.pebblewebback.application.config.PebbleWebConfig;
import com.nhn.pebblewebback.application.util.NetworkUtil;
import com.nhn.pebblewebback.exception.constant.ErrorLevel;
...
public class ContentLoggingFilter extends OncePerRequestFilter {
  ...
  private static final ObjectMapper MAPPER = PebbleWebConfig.MAPPER;
    ...
    try {
      if (StringUtils.containsIgnoreCase(type, "json")) {
        ...
        if (StringUtils.startsWith(str, "[")) {
          return Map.of("list", PebbleWebConfig.MAPPER.readValue(str, List.class));
        }

        return PebbleWebConfig.MAPPER.readValue(str, new TypeReference<>() {
        });
      }
